...
```{r, message=FALSE, warning=FALSE, dpi=600, fig.width=10, fig.height=5, fig.cap="Figure 3: Top species hits in the Kraken database (>0.1% of fragments), excluding S. mitis."}
