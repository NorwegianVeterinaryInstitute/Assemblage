...
```{r, message=FALSE, warning=FALSE, dpi=600, fig.width=10, fig.height=6, fig.cap="Figure 3: QUAST assembly general statistics."}
...
```{r, message=FALSE, warning=FALSE, dpi=600, fig.width=10, fig.height=5, fig.cap="Figure 1: Top species hits in the Kraken database (>0.1% of fragments)"}
...
contaminants <- filter(kraken_data, scientific_name != params$species_name)
...
```{r, message=FALSE, warning=FALSE, dpi=600, fig.width=10, fig.height=5, fig.cap="Figure 2: Top species hits in the Kraken database (>0.1% of fragments), excluding S. mitis."}
ggplot(contaminants, aes(reorder(scientific_name, -perc_fragments), perc_fragments)) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot(fill = "grey80") +
  labs(x = "Species",
       y = "Percent fragments") +
